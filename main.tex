...
\definecolor{SWJTUblue}{RGB}{0,118,184}
    ...
    \parbox[b][\paperheight]{\paperwidth}{
      ...
      \begin{tikzpicture}
        \node[opacity=0.07] at (current page.center)
          {\includegraphics[width=0.55\textwidth]{watermark.png}};
      \end{tikzpicture}
      \vfill
    }
  }
...
\begin{minipage}{0.5\textwidth}
    \includegraphics[width=\linewidth]{swjtu.png}
\end{minipage}
\hfill
\begin{minipage}{0.5\textwidth}
    \raggedright
    \textcolor{SWJTUblue}{\textbf{School of XXX,}} \\
    \textcolor{SWJTUblue}{\textbf{Southwest Jiaotong University}} \\
    NO.999 Xian Rd Pidu District \\
    Chengdu 611756, China \\
    \textcolor{SWJTUblue}{\textbf{Tel/Fax:}} +86 028-66366165 \\
    \textcolor{SWJTUblue}{\textbf{URL:}} \href{https://www.swjtu.edu.cn}{https://www.swjtu.edu.cn}
\end{minipage}
